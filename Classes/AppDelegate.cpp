...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("enjoyGame_chapter4", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("enjoyGame_chapter4");
#endif
    ...
    auto scene = AllAtOnceTouchEventScene::createScene();
